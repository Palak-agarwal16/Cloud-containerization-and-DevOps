...
```
![Create Application](image2.png)

**Step-3:- Create **`requirements.txt`:****
```
Flask==2.3.3
```
![Create Requirment](image3.png)
...
test_*.py
```
![Create dockerignore file](image5.png)
...
```
![Tagging Existing Image](image11.png)
...
```
![Remove Container](image21.png)


**Step-22:- If working then  Remove container forcefully** \
...
```
![Build Regular Image](image24.png)
...
```
![Build Multi-Stage Image](image25.png)
...
```
![Push 1.0 Tag Image](image29.png)

**Step-30:- Push Latest Image**
```bash
docker push username/my-flask-app:latest
```
![Push Image](image30.png)
...
```
![Create package file](image35.png)
...
```
![Create DockerFile](image39.png)


**Step-40:- Test on Browser**
![Browser Test](image40.png)
...
View Pushed Image on [DockerHub](https://hub.docker.com/repositories/palakagarwal16)

![DockerHub](image41.png)
